...
pa4.py - the main script for running the ICP algorithm. This is the script that will be ran for execution.
frameTransform.py - Frame class. Defines a transformation [R|p] and some operations
IterativeClosestPoint.py - contains a function for FindClosestPointOnMesh and BoundingSphere along with its subroutines
...
To run the code, simply change the contents of config.ini to the desired file. 'speed' is a parameter where 0 uses the fast method and 1 uses the slow method. Then, simply run 
